var FutureETH = artifacts.require("./FutureETH.sol");
...
contract('FutureETH', function(accounts) {
  it("should load the future price, seconds to wait, and owner balance at initialization.", function() {
	return Futures1.then(function(instance) {
	  return instance.getFuturesPrice.call(), instance.getFuturesSeconds.call(), instance.getSellerBalance.call();
  ...
  it("given a new price of 1000, it should calculate the transfer correctly and send it to the accounts", function() {
	return instance.processFuture(1000, {from: sellerAccount}).then(function(result) {
